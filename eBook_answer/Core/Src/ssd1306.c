...
#define SEL_SSD1306(sel) ((sel) ? SSD1306_I2C_ADDR_1 : SSD1306_I2C_ADDR_0)
/* Write command */
#define SSD1306_WRITECOMMAND(command, sel)      ssd1306_I2C_Write(SEL_SSD1306(sel), 0x00, (command))
/* Write data */
#define SSD1306_WRITEDATA(data, sel)            ssd1306_I2C_Write(SEL_SSD1306(sel), 0x40, (data))
/* Absolute value */
#define ABS(x)   ((x) > 0 ? (x) : -(x))

/* SSD1306 data buffer */
static uint8_t SSD1306_Buffer[(SSD1306_WIDTH * SSD1306_HEIGHT / 8) * 2];
...
void SSD1306_ScrollRight(uint8_t start_row, uint8_t end_row, uint8_t sel) {
	SSD1306_WRITECOMMAND(SSD1306_RIGHT_HORIZONTAL_SCROLL, sel);  // send 0x26
	SSD1306_WRITECOMMAND(0x00, sel);  // send dummy
	SSD1306_WRITECOMMAND(start_row, sel);  // start page address
	SSD1306_WRITECOMMAND(0X00, sel);  // time interval 5 frames
	SSD1306_WRITECOMMAND(end_row, sel);  // end page address
	SSD1306_WRITECOMMAND(0X00, sel);
	SSD1306_WRITECOMMAND(0XFF, sel);
	SSD1306_WRITECOMMAND(SSD1306_ACTIVATE_SCROLL, sel); // start scroll
}

void SSD1306_ScrollLeft(uint8_t start_row, uint8_t end_row, uint8_t sel) {
	SSD1306_WRITECOMMAND(SSD1306_LEFT_HORIZONTAL_SCROLL, sel);  // send 0x26
	SSD1306_WRITECOMMAND(0x00, sel);  // send dummy
	SSD1306_WRITECOMMAND(start_row, sel);  // start page address
	SSD1306_WRITECOMMAND(0X00, sel);  // time interval 5 frames
	SSD1306_WRITECOMMAND(end_row, sel);  // end page address
...
void SSD1306_Scrolldiagright(uint8_t start_row, uint8_t end_row, uint8_t sel) {
	SSD1306_WRITECOMMAND(SSD1306_SET_VERTICAL_SCROLL_AREA, sel); // sect the area
	SSD1306_WRITECOMMAND(0x00, sel);   // write dummy
	SSD1306_WRITECOMMAND(SSD1306_HEIGHT, sel);

	SSD1306_WRITECOMMAND(SSD1306_VERTICAL_AND_RIGHT_HORIZONTAL_SCROLL, sel);
	SSD1306_WRITECOMMAND(0x00, sel);
	SSD1306_WRITECOMMAND(start_row, sel);
	SSD1306_WRITECOMMAND(0X00, sel);
	SSD1306_WRITECOMMAND(end_row, sel);
	SSD1306_WRITECOMMAND(0x01, sel);
	SSD1306_WRITECOMMAND(SSD1306_ACTIVATE_SCROLL, sel);
}

void SSD1306_Scrolldiagleft(uint8_t start_row, uint8_t end_row, uint8_t sel) {
	SSD1306_WRITECOMMAND(SSD1306_SET_VERTICAL_SCROLL_AREA, sel); // sect the area
	SSD1306_WRITECOMMAND(0x00, sel);   // write dummy
	SSD1306_WRITECOMMAND(SSD1306_HEIGHT, sel);

	SSD1306_WRITECOMMAND(SSD1306_VERTICAL_AND_LEFT_HORIZONTAL_SCROLL, sel);
	SSD1306_WRITECOMMAND(0x00, sel);
	SSD1306_WRITECOMMAND(start_row, sel);
	SSD1306_WRITECOMMAND(0X00, sel);
	SSD1306_WRITECOMMAND(end_row, sel);
...
void SSD1306_Stopscroll(uint8_t sel) {
	SSD1306_WRITECOMMAND(SSD1306_DEACTIVATE_SCROLL, sel);
}

void SSD1306_InvertDisplay(int i, uint8_t sel) {
	if (i)
		SSD1306_WRITECOMMAND(SSD1306_INVERTDISPLAY, sel);

	else
		SSD1306_WRITECOMMAND(SSD1306_NORMALDISPLAY, sel);
...
void SSD1306_UpdateScreen(void) {
	...
	for (m = 0; m < 8; m++) {
		...
		ssd1306_I2C_WriteMulti(SSD1306_I2C_ADDR_0, 0x40,
				&SSD1306_Buffer[SSD1306_WIDTH * m + 1024], SSD1306_WIDTH);
...
void SSD1306_Clear(uint8_t sel) {
	SSD1306_Fill(0);
	SSD1306_Fill(0);
	SSD1306_UpdateScreen();
}
void SSD1306_ON(uint8_t sel) {
	SSD1306_WRITECOMMAND(0x8D, sel);
	SSD1306_WRITECOMMAND(0x14, sel);
	SSD1306_WRITECOMMAND(0xAF, sel);
}
void SSD1306_OFF(uint8_t sel) {
	SSD1306_WRITECOMMAND(0x8D, sel);
	SSD1306_WRITECOMMAND(0x10, sel);
	SSD1306_WRITECOMMAND(0xAE, sel);
}
