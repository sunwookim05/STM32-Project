...
void read_accel(I2C_HandleTypeDef* hi2c, mpu6050* __my_mpu6050, int unit_you_want);
void read_gyro(I2C_HandleTypeDef* hi2c, mpu6050* __my_mpu6050, int unit_you_want);
void set_sensitivity(I2C_HandleTypeDef* hi2c, mpu6050* __my_mpu6050, int gyro_range_you_want, int accel_range_you_want);
