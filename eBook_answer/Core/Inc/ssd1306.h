 ...
 */
char SSD1306_Puts(char *str, FontDef_t *Font, SSD1306_COLOR_t color, uint8_t angle);
 ...
 */
char SSD1306_Putc(char ch, FontDef_t* Font, SSD1306_COLOR_t color, uint8_t angle);
 ...
 * @retval None
 */
void SSD1306_DrawLine(uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1, SSD1306_COLOR_t c, uint8_t sel);
